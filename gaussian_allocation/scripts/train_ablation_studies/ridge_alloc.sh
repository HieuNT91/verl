...
exp_name='Qwen2.5-Math-1.5B-dpp-rloo-8-ridge'
...
MODEL_PATH=${MODEL_PATH:-"/root/verl/code_space/models/Qwen2.5-Math-1.5B"}
...
ray job submit --runtime-env="${RUNTIME_ENV}" \
    -- python3 -m gaussian_allocation.main_ridge_allocation \
